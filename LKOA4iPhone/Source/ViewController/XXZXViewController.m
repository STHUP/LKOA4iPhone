...
@interface XXZXViewController ()

@end

@implementation XXZXViewController
...
-(void)initViews{
    ...
    [_leftButton setTitle:@"信息中心" forState:UIControlStateNormal];
    [_leftButton setBackgroundImage:[UIImage imageNamed:@"item_n_left"] forState:UIControlStateNormal];
    [_leftButton setBackgroundImage:[UIImage imageNamed:@"item_n_left"] forState:UIControlStateSelected];
    [_leftButton setBackgroundImage:[UIImage imageNamed:@"item_n_left"] forState:UIControlStateNormal];
    ...
    [_rightButton setTitle:@"通  知" forState:UIControlStateNormal];
